...
class NoamScheduler(LRScheduler):
    ...
    Decay phase:   LR decreases ∝ 1/√step.
    ...
    def _get_lr_scale(self) -> float:
        """
        Noam scale factor for the current step.
        step = last_epoch + 1  (avoid step=0)
    ...
    def get_lr(self) -> list:
        """Return scaled LR for each param group."""
